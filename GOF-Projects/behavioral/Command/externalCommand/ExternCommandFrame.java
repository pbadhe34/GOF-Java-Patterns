...
public class ExternCommandFrame extends Frame  implements ActionListener
{
   Menu mnuFile;
   ...
   public ExternCommandFrame()
   {
      super("Frame with external command objects");
   ...
   {
      ExternCommandFrame frm = new ExternCommandFrame();
	  frm.setBounds(100,100,200,100);
      frm.setVisible(true);
   }
}
 //External command class: Additional External param is 'Panel' to be set
class btnRedCommand extends Button implements Command
   {
	 ...
	 //External command class: Additional External param is 'Frame' to be set
