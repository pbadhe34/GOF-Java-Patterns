 ...
 *  Creator interface 
 *
 * In this program, Main acts as the  Director that
...
public class TestBuilder
{
    ...
    public static void main(String[] args) 
	{
		...
		System.out.println("This is Plain String Represenation");
        System.out.println(textB.getResult());
		System.out.println("This is XML String Represenation");
